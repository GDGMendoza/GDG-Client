...
module.exports.policies = {
    ...
    ContributorController: {
        ...
        update: 'sessionAuth',
        destroy: 'sessionAuth',
        find: true, //tenemos que crear una politica que fuerce el limite de peticiones
        findAll: true //tenemos que crear una politica que fuerce el limite de peticiones
    },
    ...
    EventController: {
        ...
        addSession: true,
        removeSession: true,
        create: true,//'sessionAuth',
        update: true,//'sessionAuth',
        destroy: true,//'sessionAuth',
        find: true, //tenemos que crear una politica que fuerce el limite de peticiones
        findAll: true //tenemos que crear una politica que fuerce el limite de peticiones
    },
